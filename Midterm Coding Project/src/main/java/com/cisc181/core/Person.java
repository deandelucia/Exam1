...
public abstract class Person implements java.io.Serializable {
	...
	public void setDOB(Date DOB) throws PersonException{
			if (DOB.getYear()-100 >= 0)
				throw new PersonException("DOB is more than 100 years old");
			else 
				this.DOB = DOB;
	...
	public void setPhone(String newPhone_number)throws PersonException{
		...
		Matcher matcher = p.matcher(newPhone_number);
		if (!(matcher.matches()))
			throw new PersonException("Phone number is not correctly formatted");
		else 
